...
Ένα εξειδικευμένο WordPress plugin που αναπτύχθηκε για να προσφέρει δυναμικό υπολογισμό μεταφορικών εξόδων βάζοντας όποιες περιοχές θέλετε, βασισμένο σε Ταχυδρομικούς Κώδικες (ΤΚ).
...
4. ΠΡΟΣΟΧΉ! Για να δουλέψει το plugin θα πρέπει να ορίσετε σαν μέθοδο αποστολής μια όποιδήποτε τιμή flat rate.